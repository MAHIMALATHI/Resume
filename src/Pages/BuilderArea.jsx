    ...
    return (
        <>
            ...
            <div className="d-flex flex-wrap justify-content-center">
                <Button bgColor='darkslategray' textColor='white' borderRadius={'50%'} width={'10%'} className="mx-2 my-5" colorScheme="teal" variant="outline" onClick={handlePrintView}>Print</Button>
